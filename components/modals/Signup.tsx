            ...
            <ModalContent>
                ...
                <ModalBody>
                    <Flex flexDir={"column"} rowGap={"20px"}>
                        ...
                        <FloatingInput isInvalid={!!emailInvalidError || !!emailOccupiedError} errorMessage={emailInvalidError || emailOccupiedError} inputProps={{ name: "email" }} label={"Email"} onChange={(ev) => setForm({ ...form, email: ev.target.value })} />
